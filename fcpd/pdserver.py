        ...
        for msg in msgList:
            ...
            if words[0] == "initrcv":
                ...
                if self.outputSocket.waitForConnected(1000):
                    ...
                    Log(
                        "PDServer : Callback initialized to %s:%s\n"
                    ...
                    Log(
                        "PDServer : ERROR during callback initialization\n%s\n"
                ...
                returnValue.append(
                    "%s %s;" % (words[0], PDMsgTranslator.strFromValue(ret))
                )
        return returnValue
